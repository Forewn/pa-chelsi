...
<body>
    ...
    <div class="page-wrapper">
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Agregar Padres</h4>
        ...
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <form class="form-horizontal m-t-40" action="../../php/registropadres.php" method="POST" enctype="multipart/form-data" id="formulario">
                                        <div class="card-body">
                                            <div class="form-group row formulario__grupo" id="grupo__cedula_papa">
                                                ...
                                                <div class="col-sm-9 formulario__grupo-input">
                                                    <input type="text" class="form-control" id="cedula_papa" name="cedula_papa" placeholder="" required>
                                            ...
                                            <div class="form-group row formulario__grupo" id="grupo__foto_papa">
                                                <label for="foto_papa" class="col-sm-3 text-right control-label col-form-label formulario__label">Foto:</label>
                                                <div class="col-sm-9 formulario__grupo-input">
                                                    <input type="file" class="form-control" id="foto_papa" name="foto_papa" accept=".jpeg, .jpg, .png" required>
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
            ...
            <script src="../validaciones/padres.js"></script>
