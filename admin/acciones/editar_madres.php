...
<body>
    ...
    <div class="page-wrapper">
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Editar Madres</h4>
        ...
        <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    if (isset($_POST['enviar'])) {
                                        ...
                                        $id = $_GET['id'];
                                        $sql = "SELECT * FROM mama where cedula_mama='" . $id . "'";
                                        $resultado = mysqli_query($conexion, $sql);
                                        $r = mysqli_fetch_assoc($resultado);

                                    ?>
                                        <form class="form-horizontal" action="../../php/editar/editar_madres.php" method="POST" enctype="multipart/form-data" id="formulario">
                                            <input type="hidden" id="cedula_mama" name="cedula_mama" value="<?php echo $r['cedula_mama']; ?>">
                                            <div class="card-body">
                                                <div class="form-group row formulario__grupo" id="grupo__cedula_mama">
                                                    ...
                                                    <div class="col-sm-9 formulario__grupo-input">
                                                        <input type="text" class="form-control" id="cedula_mama" name="cedula_mama" placeholder="" required value="<?php echo $r['cedula_mama']; ?>" disabled>
                                                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                    </div>
                                                    <p class="formulario__input-error ">La cedula del mama debe ser de 7 u 8 campos numericos.</p>
                                                </div>
                                                ...
                                                <div class="form-group row formulario__grupo" id="grupo__codigo_estadocivil">
                                                    ...
                                                    <div class="col-sm-9 formulario__grupo-input">
                                                        ...
                                                        $siu = "SELECT * FROM mama WHERE cedula_mama = $p";
            ...
            <script src="../validaciones/editar_madre.js"></script>
