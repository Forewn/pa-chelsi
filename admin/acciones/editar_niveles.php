...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    if (isset($_POST['enviar'])) {
                                        ...
                                        $id = $_GET['id'];
                                        $sql = "SELECT * FROM niveles where codigo_niveles='" . $id . "'";
                                        $resultado = mysqli_query($conexion, $sql);
                                        $r = mysqli_fetch_assoc($resultado);

                                    ?>
                                        <form class="form-horizontal" action="../../php/editar/editar_niveles.php" method="POST" enctype="multipart/form-data" id="formulario">
                                            <input type="hidden" id="codigo_niveles" name="codigo_niveles" value="<?php echo $r['codigo_niveles']; ?>">
                                            <div class="card-body">
                                                <h4 class="card-title">Niveles Academicos</h4>
                                                <div class="form-group row formulario__grupo" id="grupo__codigo_niveles">
                                                    <label for="codigo_niveles" class="col-sm-3 text-right control-label col-form-label formulario__label">Codigo:</label>
                                                    <div class="col-sm-9 formulario__grupo-input">
                                                        <input type="text" class="form-control" id="codigo_niveles" name="codigo_niveles" placeholder="" disabled value="<?php echo $r['codigo_niveles']; ?>">
                                                ...
                                                <div class="form-group row formulario__grupo" id="grupo__descripcion">
                                                    ...
                                                    <div class="col-sm-9 formulario__grupo-input">
                                                        <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Juan" required value="<?php echo $r['descripcion']; ?>">
                                                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                    </div>
                                                ...
                                                <div class="form-group row formulario__grupo" id="grupo__codigo_estado">
                                                    ...
                                                    <div class="col-sm-9 formulario__grupo-input">
                                                        ...
                                                        $siu = "SELECT * FROM niveles WHERE codigo_niveles = $p";
            ...
            <script src="../validaciones/editar_niveles.js"></script>
